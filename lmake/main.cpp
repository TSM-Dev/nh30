...
#ifdef VORANGEBOX
# ifdef GMOD
	globals = **(Globals ***)util::FindPattern(client->GetMethod<void *>(0), 0x100, ((const pattern *)"\x02\x43\x00\x00\x00\x89\x0D\xE8"));
# else
	#error OB Globals signature is unknown
# endif
#else
	globals = **(Globals ***)util::FindPattern(client->GetMethod<void *>(0), 0x100, ((const pattern *)"\x01\x21\x00\x00\x00\xA3\xE8"));
#endif
